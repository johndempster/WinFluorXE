...
// 22.05.13 Wavelength limits of Till monochromator extended to 0-10000.
...
type
  ...
  private
   ...
   procedure MonoWithLEDWavelengthToVoltage(
          Wavelength : Single ;
          var VControl : Array of TLSVControl ;
          var NumVControl : Integer
          ) ;
...
begin
     ...
     List.Add('PTI/Till monochromator') ;
     List.Add('Sutter Lambda-10') ;
     List.Add('LED') ;
     List.Add('OptoScan + Lasers') ;
     List.Add('Sutter DG4') ;
     List.Add('Cairn TIRF') ;
     List.Add('Monochromator + LEDs') ;
...
begin
    case DeviceType of
        ...
        lsTill : Result := 10000.0 ; //original value 550; changed 14.12.2007 M.Ascherl
        lsLambda10 : Result := 0.0 ;
        lsLED : Result := 0.0 ;
        lsSutterDG4 : Result := 0.0 ;
        lsCairnTIRF : Result := 0.0 ;
        lsMonoWithLED : Result := 10000.0 ;
        else begin
             Result := 0 ;
             end ;
        end ;
...
begin
    ...
    case DeviceType of
        ...
        lsMonoWithLED : begin
            MonoWithLEDWavelengthToVoltage( Wavelength,
                                            VControl,
                                            NumVControl ) ;
            end ;
        else begin
...
begin
  ...
  //                                      NumVControl ) ;
        ...
        lsMonoWithLED : begin
            MonoWithLEDWavelengthToVoltage(
            LightSource.ShutterClosedWavelength,
                                     VControl,
                                     NumVControl ) ;
            end ;
...
const
    ...
    //Wavelength1 = 495.0 ;
    //V1 = 0.2 ;
    WavelengthMin = 0.0 ;      // Change to wider range to allow any monochromator
...
procedure TLightSource.MonoWithLEDWavelengthToVoltage(
          Wavelength : Single ;
          var VControl : Array of TLSVControl ;
          var NumVControl : Integer
          ) ;
// ---------------------------------------------------
// Get monochromator + LED control voltages for selected wavelength
// ---------------------------------------------------
const
    WavelengthMin = 0.0 ;      // Change to wider range to allow any monochromator
    WavelengthMax = 10000.0 ;
